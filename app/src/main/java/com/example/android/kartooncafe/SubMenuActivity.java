...
//        });
    ...
    public void loadMenu1() {
        ...
        menu1.add(new Item("CPJ1", "Watermelon", getString(R.string.juice1), 0, 110.0, 0, defaultCust));
        menu1.add(new Item("CPJ2", "Apple", getString(R.string.juice2), 0, 110.0, 0, defaultCust));
        menu1.add(new Item("CPJ3", "Mango", getString(R.string.juice3), 0, 110.0, 0, defaultCust));
        ...
        menu1.add(new Item("CPJ6", "Fresh Ginger ale", getString(R.string.juice6), 0, 110.0, 0, defaultCust));
        menu1.add(new Item("CPJ7", "Blue Lagoon", getString(R.string.juice7), 0, 110.0, 0, defaultCust));
        menu1.add(new Item("CPJ8", "Iced Tea", getString(R.string.juice8), 0, 110.0, 0, defaultCust));
        menu1.add(new Item("CPJ9", "Fresh Lime Soda", getString(R.string.juice9), 0, 110.0, 0, defaultCust));
    ...
    public void loadMenu2() {
        ...
        menu2.add(new Item("SHK1", "Classic Shakes", getString(R.string.shake1), 0, 190, 1, menu2custItem1));
        menu2.add(new Item("SHK2", "Banoffee Shake", getString(R.string.shake2), 0, 220, 0, defaultCust));
        menu2.add(new Item("SHK3", "Oreo Donut Shake", getString(R.string.shake3), 0, 205, 1, menu2custItem3));
        menu2.add(new Item("SHK4", "Mango Cream Shake", getString(R.string.shake4), 0, 195, 0, defaultCust));
        menu2.add(new Item("SHK5", "Brownie Shake with brownie", getString(R.string.shake5), 0, 280, 0, defaultCust));
        menu2.add(new Item("SHK6", "Strawberry Cheesecake Shake", getString(R.string.shake6), 0, 290, 0, defaultCust));
    ...
    public void loadMenu3() {
        ...
        menu3.add(new Item("CFE1", "Americano Black Coffee", "", 0, 110, 0, defaultCust));
        menu3.add(new Item("CFE2", "Grainy Cappucino", "", 0, 115, 0, defaultCust));
        menu3.add(new Item("CFE3", "Moccha", "", 0, 125, 0, defaultCust));
        menu3.add(new Item("CFE4", "Latte", "", 0, 130, 0, defaultCust));
        menu3.add(new Item("CFE5", "Cold Coffee", "", 0, 150, 0, defaultCust));
        menu3.add(new Item("CFE6", "Detox Green Tea", "", 0, 120, 0, defaultCust));
    ...
    public void loadMenu4() {
        ...
        menu4.add(new Item("SLD1", "Chicken Salad", getString(R.string.salad1), 1, 240, 0, defaultCust));
        menu4.add(new Item("SLD2", "Quinoa Salad", getString(R.string.salad2), 2, 240, 1, menu4custItem2));
    ...
    public void loadMenu5() {
        ...
        menu5.add(new Item("BPD1", "Whey Protein Shake", getString(R.string.drink1), 0, 250, 1, menu5custItem1));
        menu5.add(new Item("BPD2", "Peanut Butter Shake", getString(R.string.drink2), 0, 230, 0, defaultCust));
        menu5.add(new Item("BPD3", "Banana Shake", getString(R.string.drink3), 0, 200, 0, defaultCust));
    ...
    public void loadMenu6() {
        ...
        menu6.add(new Item("FCR2", "Whole Wheat Pizza", getString(R.string.crunch2), 2, 500, 1, menu6cutItem2));
        ...
        menu6.add(new Item("FCR5", "Pita with Hummus", getString(R.string.crunch5), 1, 500, 1, menu6cutItem5));
    ...
    public void loadMenu7() {
        ...
        ArrayList<Customizables> defaultCust = new ArrayList<>();
        menu7.add(new Item("CRST1", "Butterly Delicious Layered", getString(R.string.croissants1), 2, 180, 1, menu7custItem1));
        menu7.add(new Item("CRST2", "Stuffed Croissant", getString(R.string.croissants2), 2, 110, 1, menu7custItem2));
        menu7.add(new Item("CRST3", "Chocolate Croissant", getString(R.string.croissants3), 0, 175, 0, defaultCust));
    }

    public void loadMenu8() {
        ArrayList<Customizables> defautCust = new ArrayList<>();

        menu8.add(new Item("BRFS1", "Waffles with Nuts", getString(R.string.breakfast1), 0, 150, 0, defautCust));
        menu8.add(new Item("BRFS2", "Pan Cakes", getString(R.string.breakfast2), 0, 210, 0, defautCust));
        menu8.add(new Item("BRFS3", "Belle's Special", getString(R.string.breakfast3), 0, 145, 0, defautCust));
        menu8.add(new Item("BRFS4", "Omlette", getString(R.string.breakfast4), 0, 190, 0, defautCust));
        menu8.add(new Item("BRFS5", "French Toast Style", getString(R.string.breakfast5), 0, 210, 0, defautCust));
    }
    ...
    public void loadMenu9() {
        ...
        menu9.add(new Item("SSLD2", "Mushroom Soup ", getString(R.string.soup2), 2, 175, 0, defautCust));
        menu9.add(new Item("SSLD3", "Lemon Coriander Soup", getString(R.string.soup3), 2, 145, 1, menu9custItem3));
        menu9.add(new Item("SSLD4", "Manchow Soup", getString(R.string.soup4), 2, 155, 1, menu9custItem4));
        menu9.add(new Item("SSLD5", "Chicken Soup", getString(R.string.soup5), 2, 190., 0, defautCust));
        menu9.add(new Item("SSLD6", "Green Salad", getString(R.string.soup6), 2, 190, 1, menu9custItem6));
        menu9.add(new Item("SSLD7", "Caesar Salad", getString(R.string.soup7), 2, 190, 1, menu9custItem7));
    }
    ...
    public void loadMenu10() {
        ...
        menu10.add(new Item("STRS1", "Spring Roll", getString(R.string.starters1), 2, 210, 1, menu10custitem1));
        menu10.add(new Item("STRS2", "Pita with Hummus", getString(R.string.starters2), 2, 280, 1, menu10custitem2));
        menu10.add(new Item("STRS3", "Manchurian", getString(R.string.starters3), 2, 270, 1, menu10custitem3));
        menu10.add(new Item("STRS4", "Honey Chilli Chicken", getString(R.string.starters4), 0, 280, 0, defaultCust));
        menu10.add(new Item("STRS5", "Crispy Fried Chicken Wings or POPCORNS", getString(R.string.starters5), 0, 370, 0, defaultCust));
        menu10.add(new Item("STRS6", "Fried Rice", getString(R.string.starters6), 2, 190, 1, menu10custitem6));
        menu10.add(new Item("STRS7", "Noodles", getString(R.string.starters7), 2, 190, 1, menu10custitem7));
        menu10.add(new Item("STRS8", "Garlic Bread", getString(R.string.starters8), 2, 110, 1, menu10custitem8));
    ...
    public void loadMenu11() {
        ...
        menu11.add(new Item("BSDW1", "Veg Burger", getString(R.string.burger1), 0, 220, 0, defaultCust));
        menu11.add(new Item("BSDW2", "Cheesy chicken burger", getString(R.string.burger2), 1, 270, 0, defaultCust));
        menu11.add(new Item("BSDW3", "Lamb Burger", getString(R.string.burger3), 1, 290, 0, defaultCust));
        menu11.add(new Item("BSDW4", "Zingy Chicken Sandwich", getString(R.string.burger4), 2, 215, 1, menu11custItem4));
        menu11.add(new Item("BSDW5", "Croissant Sandwich", getString(R.string.burger5), 2, 220, 1, menu11custItem5));
        menu11.add(new Item("BSDW6", "Club Sandwich", getString(R.string.burger6), 2, 280, 1, menu11custItem6));
    }
    ...
    public void loadMenu12() {
        ...
        menu12.add(new Item("PIZA1", "Plain cheese Pizza", getString(R.string.pizza1), 0, 350, 0, defaultCust));
        menu12.add(new Item("PIZA2", "Margaritha Pizza", getString(R.string.pizza2), 0, 370, 0, defaultCust));
        menu12.add(new Item("PIZA3", "Red Pepper Pizza", getString(R.string.pizza3), 0, 400, 0, defaultCust));
        menu12.add(new Item("PIZA4", "Smoked sausage Pizza", getString(R.string.pizza4), 1, 480, 0, defaultCust));
        menu12.add(new Item("PIZA5", "Peppery Pepperoni Pizza", getString(R.string.pizza5), 0, 650, 0, defaultCust));
        menu12.add(new Item("PIZA6", "Zesty Barbeque Chicken Pizza", getString(R.string.pizza6), 1, 600, 0, defaultCust));
        menu12.add(new Item("PIZA7", "Garlic Prawn Pizza", getString(R.string.pizza7), 1, 550, 0, defaultCust));
        menu12.add(new Item("PIZA8", "Calzone", getString(R.string.pizza8), 2, 460, 1, menu12custItem8));
    }
    ...
    public void loadMenu13() {
        ...
        menu13.add(new Item("PST1", "Arabiatta", getString(R.string.pasta1), 2, 240, 1, menu13custItem1));
        menu13.add(new Item("PST2", "Tomato", getString(R.string.pasta2), 2, 280, 1, menu13custItem2));
        menu13.add(new Item("PST3", "Creamy mushroom sauce", getString(R.string.pasta3), 2, 300, 1, menu13custItem3));
        menu13.add(new Item("PST4", "Bolognese", getString(R.string.pasta4), 2, 350, 1, menu13custItem4));
        menu13.add(new Item("PST5", "Infused Lasagne", getString(R.string.pasta5), 2, 340, 1, menu13custItem5));
        menu13.add(new Item("PST6", "Rissotto", getString(R.string.pasta6), 2, 370, 1, menu13custItem6));
    }
    ...
    public void loadMenu14() {
        ...
        ArrayList<Customizables> defaultCust = new ArrayList<>();
        menu14.add(new Item("MIMX1", "Golden Enhchilada", getString(R.string.mexico1), 2, 280, 1, menu14custitem1));
        menu14.add(new Item("MIMX2", "Grilled Quesadilla", getString(R.string.mexico2), 2, 260, 1, menu14custitem2));
        menu14.add(new Item("MIMX3", "Spicy Tacos", getString(R.string.mexico3), 2, 295, 1, menu14custitem3));
        menu14.add(new Item("MIMX4", "Nachos", getString(R.string.mexico4), 2, 110, 0, defaultCust));
    }

    public void loadMenu15() {
        ArrayList<Customizables> defaultCust = new ArrayList<>();
        menu15.add(new Item("DIMS1", "Original Veg", getString(R.string.dimsums1), 0, 150, 0, defaultCust));
        menu15.add(new Item("DIMS2", "Lemongrass and Chilli", getString(R.string.dimsums2), 0, 170, 0, defaultCust));
        menu15.add(new Item("DIMS3", "Corn and Spinach", getString(R.string.dimsums3), 0, 165, 0, defaultCust));
        menu15.add(new Item("DIMS4", "Chicken Homemade", getString(R.string.dimsums4), 1, 190, 0, defaultCust));
        menu15.add(new Item("DIMS5", "Shredded Lamb", getString(R.string.dimsums5), 1, 220, 0, defaultCust));
    }
    ...
    public void loadMenu16() {
        ...
        menu16.add(new Item("PRD2", "Salut Sizzlers", getString(R.string.parade2), 2, 400, 1, menu16custItem2));
        menu16.add(new Item("PRD3", "Sushi", getString(R.string.parade3), 2, 640, 1, menu16custItem3));
        menu16.add(new Item("PRD4", "Fish Cake", getString(R.string.parade4), 1, 550, 0, defaultCust));
        menu16.add(new Item("PRD5", "Kung Pao Chicken", getString(R.string.parade5), 1, 350, 0, defaultCust));
        menu16.add(new Item("PRD6", "Fish & Chips", getString(R.string.parade6), 1, 500, 0, defaultCust));
        menu16.add(new Item("PRD7", "Chicken", getString(R.string.parade7), 1, 460, 0, defaultCust));
        menu16.add(new Item("PRD8", "Fried Prawns", getString(R.string.parade8), 1, 650, 0, defaultCust));
        menu16.add(new Item("PRD9", "Chinese Bowl", getString(R.string.parade9), 2, 350, 1, menu16custItem9));
    }
    ...
    public void loadMenu17() {
        ...
        menu17.add(new Item("PTP1", "Veg Platter", getString(R.string.platter1), 0, 370, 0, defaultCust));
        menu17.add(new Item("PTP2", "Fiery Non Veg Platter", getString(R.string.platter2), 1, 450, 0, defaultCust));
    ...
    public void loadMenu18() {
        ...
        menu18.add(new Item("CHN1", "Veg Platter", getString(R.string.chinese1), 0, 440, 0, defaultCust));
        menu18.add(new Item("CHN2", "Non Veg Platter", getString(R.string.chinese2), 0, 550, 0, defaultCust));
        menu18.add(new Item("CHN3", "Small Chinese Platter", getString(R.string.chinese3), 2, 350, 1, menu18custItem3));
    }
    ...
    public void loadMenu19() {
        ...
        menu19.add(new Item("ARB1", "Herby Veg Platter", getString(R.string.arabic1), 0, 420, 0, defaultCust));
        menu19.add(new Item("ARB2", "Low Cal Non Veg Platter", getString(R.string.arabic2), 1, 520, 0, defaultCust));
        menu19.add(new Item("ARB3", "Platter", getString(R.string.arabic3), 2, 320, 1, menu19custItem3));
    }

    public void loadMenu20() {
        ArrayList<Customizables> defaultCust = new ArrayList<>();
        menu20.add(new Item("DSRT1", "Baked Cheese Cake", getString(R.string.dessert1), 3, 190, 0, defaultCust));
        menu20.add(new Item("DSRT2", "Cheese Cake", getString(R.string.dessert2), 3, 210, 0, defaultCust));
        menu20.add(new Item("DSRT3", "Mango Cheese Cake", getString(R.string.dessert3), 3, 170, 0, defaultCust));
        menu20.add(new Item("DSRT4", "Blue Berry Cheese Cake", getString(R.string.dessert4), 3, 170, 0, defaultCust));
        menu20.add(new Item("DSRT5", "Choco Fudge Brownies", getString(R.string.dessert5), 0, 240, 0, defaultCust));
        menu20.add(new Item("DSRT6", "Safron Baked Yogurt", getString(R.string.dessert6), 0, 200, 0, defaultCust));
